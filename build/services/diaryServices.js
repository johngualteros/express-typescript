...
exports.addDiary = exports.getEntriesWithSensitiveInfo = exports.findById = exports.getEntries = void 0;
...
const getEntriesWithSensitiveInfo = () => {
    return diaries.map(({ id, date, weather, visibility }) => ({ id, date, weather, visibility }));
};
exports.getEntriesWithSensitiveInfo = getEntriesWithSensitiveInfo;
